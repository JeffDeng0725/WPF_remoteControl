...
namespace MyToDo1
{
    ...
    {
        private ConcurrentQueue<MyToDo1.Command.Command> _commandQueue = new ConcurrentQueue<MyToDo1.Command.Command>();
        ...
        public void Start()
        {
            ...
            _task = Task.Run(() =>
            {
                while (_running)
                {
                    ...
                    MyToDo1.Command.Command command = null;
        ...
        public void PostCommand(MyToDo1.Command.Command command)
        {
            _commandQueue.Enqueue(command);
        }
    }
