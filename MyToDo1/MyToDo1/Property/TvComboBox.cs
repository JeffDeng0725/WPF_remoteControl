...
{
    class TvComboBox : ComboBox, IObserver
    {
        private ActionSource _actionSource;
        private EDSDKLib.EDSDK.EdsPropertyDesc _desc;

        private Dictionary<uint, string> map = new Dictionary<uint, string>();
        ...
        protected override void OnSelectionChanged(SelectionChangedEventArgs e)
        {
            ...
            if (SelectedItem != null)
            {
                ...
                _actionSource.FireEvent(ActionEvent.Command.SET_TV, (nint)key);
            }
        }
                ...
                if (propertyID == EDSDKLib.EDSDK.PropID_Tv)
                {
                    ...
                    switch (eventType)
                    {
                        ...
                        case CameraEvent.Type.PROPERTY_DESC_CHANGED:
                            _desc = model.TvDesc;
                            // Here you can update the ComboBox options if needed based on _desc
                            SelectedItem = map[property];
                            break;
                    }
                }
