    ...
    class StartEvfCommand : Command
    {
        ...
        public override bool Execute()
        {
            ...
            if (err == EDSDKLib.EDSDK.EDS_ERR_OK)
            {
                ...
                // device |= EDSDKLib.EDSDK.EvfOutputDevice_PC_Small;
                /*
                In addition, Replace the definition `EvfOutputDevice_PC` to `EvfOutputDevice_PC_Small`in the following file as well
                 * DownloadEvfCommand.cs
                 * EndEvfCommand.cs
                 * EvfPictureBox.cs                    
                */
